<template>
  <div class="slider">
    <div class="slider__wrapper">
      <div v-if="!hideLabel" :style="{ left: position }" class="slider__label">
        {{ sliderLabel }}
      </div>
      <div
        class="slider__track"
...
export default {
  ...
  computed: {
    ...
    position() {
      ...
      const clientWidth =
        this.$refs.slider !== undefined ? this.$refs.slider.clientWidth : null;
      const width = (clientWidth || this.sliderWidth) - 20;
...
$label-background: transparent !default;
$label-shadow: 0 10px 20px -5px rgba(45, 45, 45, 0.25);

$slider-track-background: #7367f0 !default;
$slider-track-height: 3px !default;

$thumb-background: #7367f0 !default;
$thumb-size: 20px;
